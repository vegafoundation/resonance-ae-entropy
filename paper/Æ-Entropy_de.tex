...
\title{Æ-Entropy: Ein konzeptioneller Rahmen}
...
\begin{abstract}
Diese Arbeit führt Æ-Entropy als neues konzeptionelles Rahmenwerk innerhalb des Resonance Data und QIRC Paradigmas ein. Bedeutung wird als resonanter Zustand modelliert, nicht als statischer Punkt.
...
Æ-Entropy represents a novel contribution to the field of meaning-first computing
and resonance-based information processing.

\section{Definition}
Æ-Entropy is defined as a conceptual framework that...
...
Æ-Entropy extends the Resonance Data paradigm by...
...
\section{Conclusion}
Æ-Entropy provides a new lens for understanding meaning
